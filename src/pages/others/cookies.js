        ...
        <>
            ...
            <div className="p-2">
                <div className="bg-white p-4 py-8 mt-12">
                    <h4 className="text-3xl font-bold text-black-800 text-center">Cookies &amp; Policy</h4>
            ...
            <!-- This is an example component --> */}
                    <div className="max-w-2xl mx-auto bg-white p-5 text-gray-600 mb-10">
                        ...
                        <br/>
                        <p>Last updated: February 24, 2023</p><br/>
                        <p>This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can understand what type of cookies We use, or the information We collect using Cookies and how that information is used.</p><br/>
                        <p>Cookies do not typically contain any information that personally identifies a user, but personal information that we store about You may be linked to the information stored in and obtained from Cookies. For further information on how We use, store and keep your personal data secure, see our Privacy Policy.</p><br/>
                        <p>We do not store sensitive personal information, such as mailing addresses, account passwords, etc. in the Cookies We use.</p> <br/>
                        <h1 className='font-bold'>Interpretation and Definitions</h1><br/>
                        ...
                        <p>For the purposes of this Cookies Policy:</p><br/>
                        <ul>
                            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to BDROp, Bhopal, MP.</li>
                            <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
                            <li><strong>Website</strong> refers to BDROP, accessible from <a href="http://www.mysite.com" rel="noreferrer external nofollow noopener" target="_blank">http://www.mysite.com</a></li>
                        ...
                        <ul>
                            <li>By email: support@bdrop.com</li>
                        </ul>
                    </div>
                </div>
            </div>
